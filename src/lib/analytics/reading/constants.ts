...
export const HOT_MAX_SHARE = 0.2;           // hot people kept, as a share of people with detail
export const HOT_MIN_KEEP = 3;
...
export const ATTENTION_MAX_ROWS = 5;         // rows the page shows before "show more"
export const ATTENTION_LIST_MAX = 25;
