...
- Personal Free workspaces get **100 credits to start, once** (no monthly top-up since 2026-09-16), with at most **15 credits per day**. Team workspaces on Free get the same one-time grant (decided 2026-09-17: every non-Pro workspace qualifies, `starterCreditsForWorkspace`).
