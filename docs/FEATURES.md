...
- **Credits (billing-cycle-based)**:
  ...
  - Personal Free workspaces get **100 credits to start, once** (no monthly top-up since 2026-09-16), with at most 15 credits a day; team workspaces on Free get no allowance. Once spent, personal Free can turn on-demand on itself (pay-as-you-go) at $0.10/credit, same as Pro's on-demand.
