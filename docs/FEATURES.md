...
- **Download CSV.** `GET /api/contacts/export` takes the list's filters and sort and answers `text/csv` as `contacts-<workspace>-<yyyymmdd>.csv`, RFC 4180 quoted, up to 10,000 rows. Redacted rows have empty name and email cells, never a placeholder.
